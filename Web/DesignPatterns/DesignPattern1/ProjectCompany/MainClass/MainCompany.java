...
import ProjectCompany.Utility.Util;
...
public class MainCompany {
	...
	public static void main(String[] args) {
		...
		int choice;
		do {
			choice = Util.getChoice("1. Create Engineer\n2. Show List\n3. Exit\nEnter Choice");
			switch(choice) {
				case 1:
					/* input name */
					name = Util.readString("Enter Name");
					type = Util.getIntegerValue("Enter 1 for Developer and 2 for Tester");
