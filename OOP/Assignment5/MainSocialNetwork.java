		...
		try {
			...
			do {
				...
				case 3:
					...
					person = dataFromUser.getPersonDetail();

					result = socialNetworkObj.addNode(person);
					if (result == 0) {
						System.out.println("Exception occured");
					} else if (result == -1) {
						System.out
								.println("node can not be added, already exists");
					} else {
				...
				case 4:
					...
					result = socialNetworkObj.addEdge(firstPersonName,
							secondPersonName);
					if (result == 0) {
						System.out.println("Exception Occured");
					} else if (result == 1) {
				...
				case 6:
					name = dataFromUser.getPersonName();
					socialNetworkObj.searchDisplay(name);
					break;
				...
				case 7:
					...
					socialNetworkObj.removeEdge(firstPersonName1,
							secondPersonName1);
					break;
