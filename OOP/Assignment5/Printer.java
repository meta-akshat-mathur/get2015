...
public class Printer {
	...
	public static void displaySocialNetwork() {
		...
		while (entityIterator.hasNext()) {
			...
			if (entityTemp.setFriends.size() != 0) {
				...
				Iterator<Entity> iteratorEntityTempFriends = entityTemp.setFriends
						.iterator();
	...
	public static void displayRecords() {
		System.out.println();
		System.out
				.println("Name \t\t\tEmail\t\t\t\tPhone No\t\tSchool Name\tCollege Name\n");
		...
		System.out.println();
		System.out
				.println("Name \t\tEmail\t\t\tPhone No\t\tCourses\t\tPlacements\n");
		Iterator<Organisation> iteratorOrganisationSet = SocialNetwork.organisationSet
				.iterator();
