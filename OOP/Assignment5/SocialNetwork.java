...
public class SocialNetwork extends Graph {
	...
	final static String PERSONFILE = "C:/Users/Akshat/Desktop/Person.txt";
	final static String ORGANISATIONFILE = "C:/Users/Akshat/Desktop/Organisation.txt";
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				if (organisationDetails.length == 5) {
					...
					organisation.setNumberOfCoursesOffered(Integer
							.parseInt(organisationDetails[3].trim()));
					organisation.setNumberOfPlacements(Integer
							.parseInt(organisationDetails[4].trim()));
