...
import com.vehiclemanagement.fascade.MetaCRMFacade;
import com.vehiclemanagement.model.Car;
import com.vehiclemanagement.model.User;
...
public class MetaCRMService {
	 ...
	 * @return returns the username of the admin
	 ...
	 * @return returns the number of rows affected by the insert query
	 * @throws MetaCRMSystemException
	 *             throws MetaCRMException if any error occurs while fetching
	 *             values from database
	 */
	 ...
	 * @param oldModel
	 *            value holds the old make of the car to be edited
	 * @return eturns the number of rows affected by the update query
	 * @throws MetaCRMSystemException
	 *             throws MetaCRMException if any error occurs while fetching
	 *             values from database
	 */
	...
	/**
	 * @param make
	 *            value holds the make of the car for which details is to be
	 *            displayed
	 * @param model
	 *            value holds the model of the car for which details is to be
	 *            displayed
	 * @return returns the list of the car returned by the select query
	 * @throws MetaCRMSystemException
	 *             throws MetaCRMException if any error occurs while fetching
	...
	/**
	 * @return returns the JSONObject of the map returned by the select query
	 * @throws MetaCRMSystemException
	 *             throws MetaCRMException if any error occurs while fetching
	 *             values from database
	 */
